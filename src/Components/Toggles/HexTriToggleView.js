  ...
  return (
    <div className="flex flex-col items-center w-full max-w-5xl mx-auto space-y-8">
      <div className="relative w-full max-w-lg h-14 select-none">
        <div className="absolute inset-0 bg-[#086CB4] blur-xl opacity-20 transition-opacity"></div>
        ...
        >
          <div 
            className="absolute inset-0 bg-gradient-to-r from-transparent via-[#086CB4]/40 to-transparent transition-transform duration-500 ease-out w-[300%]"
            style={{ 
              transform: selectedIndex === 0 ? 'translateX(-33%)' : selectedIndex === 1 ? 'translateX(0%)' : 'translateX(33%)'
            }}
          />
        ...
        <div 
          className={`absolute top-1/2 -translate-y-1/2 w-12 h-12 z-20 pointer-events-none transition-all duration-500 cubic-bezier(0.4, 0, 0.2, 1) flex items-center justify-center
