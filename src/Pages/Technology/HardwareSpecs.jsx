...
const specs = [
  {
    ...
    items: [
      { 
        ...
        detail: "Captures subcutaneous vein patterns invisible to the naked eye.", 
        icon: <Eye className="w-5 h-5" />,
        stat: "850nm"
      },
      { 
        title: "Intelligent LED Array", 
        detail: "Adaptive infrared illumination for varied lighting conditions.", 
        ...
        <div className="sticky top-24">
          <div className="aspect-[4/5] bg-zinc-900 rounded-3xl border border-zinc-800 p-8 flex flex-col justify-between overflow-hidden relative group">
            ...
            <div className="relative z-10">
                <span className="text-xs font-mono text-zinc-500">SYSTEM ARCHITECTURE</span>
            </div>
            ...
            <div className="relative z-10">
                ...
                <p className="text-zinc-400 text-sm">
                    Precision hardware components working in unison to deliver low-FAR authorization.
                </p>
            </div>
          </div>
        </div>
