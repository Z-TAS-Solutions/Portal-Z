    ...
    <div className="flex flex-col items-center w-full max-w-5xl mx-auto space-y-8">
      <div className="relative w-full max-w-lg h-14 select-none">
        ...
        >
          <div
            ...
            style={{
              ...
              background:
                "radial-gradient(circle, rgba(8,108,180,0.6) 0%, rgba(8,108,180,0) 70%)",
            }}
          />
          ...
          <div className="absolute inset-0 flex">
            {labels.map((label, idx) => (
              ...
              >
                <span
                  className={`text-[10px] md:text-xs font-bold tracking-[0.15em] transition-all duration-300 
                  ${
                    selectedIndex === idx
        ...
        >
          ...
          >
            <div
              className="w-3 h-3 bg-white shadow-[0_0_10px_white]"
